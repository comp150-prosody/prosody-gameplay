...
#sendToFile()
#purpose: Locate most probable emotion, convert to string, and write to file
#parameters: a list of floats --> the emotion probabilities


def sendToFile(emotions):
	...
	output = str(3) + " " + maxEmotion + "\n"
	
	emotionFile = open("emotions", 'a')
	emotionFile.write(maxEmotion)
	#lineNum += 1
	emotionFile.close()
...
if quality.valid:
	...
	emotions = [emotionProbabilities.neutrality, emotionProbabilities.happiness, emotionProbabilities.sadness, 
	...
	#print ("\n\nThe most probable emotion is %s" % maxEmotion)
